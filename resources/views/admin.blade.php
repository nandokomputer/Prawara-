 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Dashboard Prawara</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-warning elevation-1"><i class="fas fa-user-plus" style="color: white;"></i></span>
            ...
            <div class="card">
              ...
              <!-- <div class="card-body">
                <div class="row">
                  <div class="col-md-8">
                    <p class="text-center">
                      <strong>Penjualan : 1 May, 2022 - 30 May, 2022</strong>
                    </p>
                  ...
                  <div class="col-md-4">
                    ...
                    <!-- /.progress-group -->
                    <div class="progress-group">
                      <span class="progress-text">Pesanan Selesai</span>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3 col-6">
                    <div class="description-block">
                      ...
                      <span class="description-text">YANG DIHARAPKAN</span>
                    </div>
                    <!-- /.description-block -->
                  </div>
                </div>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="row">
                  ...
                  <div class="card-body">
                    ...
                    <div class="direct-chat-messages">
                      ...
                      <div class="direct-chat-msg">
                        ...
                        <!-- /.direct-chat-infos -->
                        <img class="direct-chat-img" src="/adminlte/dist/img/admin.jpg" alt="message user image">
                        <!-- /.direct-chat-img -->
                      ...
                      <div class="direct-chat-msg right">
                        <div class="direct-chat-infos clearfix">
                          <span class="direct-chat-name float-right">Angelina Jolie</span>
                          <span class="direct-chat-timestamp float-left">23 Jan 2:05 pm</span>
                        </div>
                        <!-- /.direct-chat-infos -->
                        <img class="direct-chat-img" src="/adminlte/dist/img/user3.jpg" alt="message user image">
                        <!-- /.direct-chat-img -->
                        <div class="direct-chat-text">
                          Saya ingin mengecek status paket saya No.Pesanan 7486123.
                        </div>
                        <!-- /.direct-chat-text -->
                      </div>
                      <!-- /.direct-chat-msg -->
                      ...
                      <div class="direct-chat-msg">
                        ...
                        <!-- /.direct-chat-img -->
                        <div class="direct-chat-text">
                          Baik tunggu sebentar akan saya bantu cek.
                        </div>
                        <!-- /.direct-chat-text -->
                      </div>
                      <!-- /.direct-chat-msg -->
              ...
              <div class="col-md-6">
                ...
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Laporan Admin</h3>
                  ...
                  <div class="card-footer text-center">
                    <a href="javascript:">Lihat Admin Lain</a>
                  </div>
                  <!-- /.card-footer -->
                </div>
                <!--/.card -->
                ...
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tr>
                      ...
                      <td>Aquarium Akrilik</td>
                      <td><span class="badge badge-warning">Kurir</span></td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Filter Gantung</td>
                      <td><span class="badge badge-info">Gudang</span></td>
                      <td>
                    ...
                    <tr>
                      <td><a href="pages/examples/invoice.html">OR7429</a></td>
                      <td>Filet External</td>
                      <td><span class="badge badge-danger">Pengemasan</span></td>
                      <td>
                        <div class="sparkbar" data-color="#00c0ef" data-height="20">63</div>
                      </td>
                    </tr>
                    <tr>
                      <td><a href="pages/examples/invoice.html">OR1848</a></td>
                    ...
                    <tr>
                      <td><a href="pages/examples/invoice.html">OR9842</a></td>
                      <td>Hardscape Air Terjun</td>
                      <td><span class="badge badge-warning">Kurir</span></td>
                      <td>
                        <div class="sparkbar" data-color="#00a65a" data-height="20">80</div>
                      </td>
                    </tr>
                    </tbody>
                  </table>
          ...
          <div class="col-md-4">
            ...
            <div class="info-box mb-3 bg-info">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Pengemasan</span>
            ...
            <div class="info-box mb-3 bg-warning">
              <span class="info-box-icon"><i class="fas fa-paper-plane" style="color: white;"></i></span>
            ...
            <div class="info-box mb-3 bg-success">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Sampai</span>
            ...
            <div class="info-box mb-3 bg-danger">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Bermasalah</span>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Barang Populer</h3>
                ...
                <ul class="products-list product-list-in-card pl-2 pr-2">
                  <li class="item">
                    <div class="product-img">
                      <img src="/img/shop/shop1.jpg" alt="Product Image" class="img-size-50">
                    </div>
                    <div class="product-info">
                      <a href="javascript:void(0)" class="product-title">Aquarium
                  ...
                  <li class="item">
                    <div class="product-img">
                      <img src="/img/shop/shop2.jpg" alt="Product Image" class="img-size-50">
                    </div>
                    <div class="product-info">
                      <a href="javascript:void(0)" class="product-title">Alat Kebutuhan
                  ...
                  <li class="item">
                    <div class="product-img">
                      <img src="/img/shop/shop3.jpg" alt="Product Image" class="img-size-50">
                    </div>
                    <div class="product-info">
                      <a href="javascript:void(0)" class="product-title">
                        Hardscape<span class="badge badge-danger float-right">
                        $350
                      </span>
                      </a>
                      <span class="product-description">
                        Set Pohon Beringin + Moss Pearl
                      </span>
                    </div>
                  </li>
                  <!-- /.item -->
                  <li class="item">
                    <div class="product-img">
                      <img src="/img/shop/shop4.jpg" alt="Product Image" class="img-size-50">
                    </div>
                    <div class="product-info">
                      <a href="javascript:void(0)" class="product-title">Peralatan
                        <span class="badge badge-success float-right">$399</span></a>
                      <span class="product-description">
                        Paket Pupuk Dasar dan Pupuk Cair.
                      </span>
                    </div>
                  </li>
                  <!-- /.item -->
              ...
              <!-- /.card-body -->
              {{-- <div class="card-footer text-center">
                <a href="/produk" class="uppercase">Lihat Produk Lainnya</a>
              </div> --}}
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
